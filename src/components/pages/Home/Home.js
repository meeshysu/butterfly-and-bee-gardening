  ...
  render() {
    return (
      <div className="Home row">
        <img src={header} alt='header' className='header-home-div justify-content-start'></img>
        <div className='about-home-container'>
          <div className='about-home-descrip'>
          ...
          <img src={BlackSwallowtailBorder} alt='frame' className='butterfly-home-frame'></img>
        </div>
        <ul className='about-bee-home-header p-2'>
          <img src={aboutBees} alt='frame' className='aboutBeesHome-div'></img>
        </ul>
      <div className='about-bee-home-container row align-items-end mx-2'>
        <div className='about-bee-home-descrip col-7'>
          ...
          Bees are fascinating creatures. Honey bees can travel up to 3 miles away from their hives. It's important for us to plant flowers for them in our gardens, too. Just because we don't have hives, doesn't mean that we can't help out.
            ...
            <img src={BlackSwallowtailBorderReverse} alt='frame' className='butterfly-home-frame-reverse justify-content-start'></img>
      </div>
      <ul className='about-butter-home-header col-3 p-2'>
        <img src={aboutButterflies} alt='frame' className='aboutButterfliesHome-div'></img>
      </ul>
      <div className='about-home-butter-container mx-2'>
        <div className='about-home-butter-descrip col-7'>
