    ...
    return (
      <div className="Auth row">
        ...
        <div className='about-container'>
          <div className='about-descrip justify-content-center'>
          ...
          <img src={BlackSwallowtailBorder} alt='frame' className='butterfly-frame d-flex justify-content-end'></img>
        </div>
        <ul className='about-bee-header'>
          <img src={aboutBees} alt='frame' className='aboutBees-div'></img>
        </ul>
      <div className='about-bee-container'>
