    ...
    return (
      <div className="Auth row">
        ...
        <div className='about-container'>
          <div className='about-descrip d-flex justify-content-center'>
      ...
      <div className='about-bee-container row align-items-end mx-2'>
        <div className='about-bee-descrip col-7'>
      ...
      <ul className='d-flex align-self-end'>
        <button className="btn btn-info mx-2 d-flex justify-content-center" onClick={this.authenticateUser}>Login To View Plants & Create A Garden</button>
      </ul>
      </div >
    );
  }
